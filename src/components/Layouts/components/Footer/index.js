            ...
            <div className={cx('inner')}>
                <div className={cx('content')}>
                    ...
                    <p className={cx('desc')}>
                        ...
                        những chuyến đi mang đầy trải nghiệm. Với Luxstay, việc đặt chỗ ở, biệt thự nghỉ dưỡng, khách
                        sạn, nhà riêng, chung cư... trở nên nhanh chóng, thuận tiện và dễ dàng.
                    </p>
